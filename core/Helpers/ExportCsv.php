...
class ExportCsv
{
     ...
     */
    #[NoReturn] public function export($dataHeader, $dataExport, bool $isSJIS = false, string $delimiter = ',')
    {
     ...
     * @return string|null
     */
    protected function _setSJIS($filename): string|null
    {
     ...
     * @return false|int
     */
    protected function _putItemCsv($handle, $item, $delimiter): bool|int
    {
