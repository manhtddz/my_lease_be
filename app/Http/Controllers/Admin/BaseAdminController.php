...
class BaseAdminController extends Controller
{
    ...
    protected string|null $formDataKeySuffix;
    ...
    public function store()
    {
        ...
        try {
            ...
            if (!$validate) {
                logError(__('messages.create_failed') . "(" . jsonEncode($this->validator->customErrorsBag()) . ")");
                $response['status'] = false;
    ...
    public function update($id)
    {
        ...
        if (!$validateShow) {
            logError(__('messages.update_failed') . "(" . jsonEncode($this->validator->customErrorsBag()) . ")");
            $response['status'] = false;
